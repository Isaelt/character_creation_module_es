...
def start_training(char_name: str, char_class: str) -> str:
    ...
    print('Introduce uno de estos comandos: atacar, para atacar un enemigo;'
          ' defender, para bloquear un ataque enemigo; o especial, para usar'
          ' tu poder especial.')
...
def choice_char_class():
    ...
    while approve_choice != 'y':
        ...
        if char_class == 'warrior':
            print('Guerrero: un feroz luchador cuerpo a cuerpo. Fuerte,'
                  ' resiliente y valiente.')
        if char_class == 'magician':
            print('Mago: un brillante luchador de largo alcance. Maestro de'
                  ' poderes mágicos.')
        if char_class == 'healer':
        ...
        approve_choice = input('Presiona (Y) para confirmar o cualquier otro'
                               ' botón para seleccionar cualquier'
                               ' otra clase').lower()
    return char_class
